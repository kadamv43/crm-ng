...
export class BranchListComponent {
    ...
    loadBLogs(event: any) {
        ...
        this.branchesService.getAll(queryParams).subscribe((data: any) => {
    ...
    confirm2(event: Event, user) {
        this.confirmationService.confirm({
            ...
            accept: () => {
                this.branchesService.delete(user._id).subscribe((res) => {
    ...
    filter() {
        ...
        let queryParams = this.commonService.getHttpParamsByJson(params);
        this.branchesService.getAll(queryParams).subscribe((res) => {
            this.appointments = res;
        });
    }
    async updateStatus(id, status) {
        this.branchesService.update(id, { status }).subscribe((res) => {
            this.messageService.add({
                // key: 'tst',
                severity: 'success',
