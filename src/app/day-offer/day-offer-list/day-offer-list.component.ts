...
@Component({
    selector: 'app-day-offer-list',
    templateUrl: './day-offer-list.component.html',
    styleUrl: './day-offer-list.component.scss',
    providers: [MessageService, ConfirmationService, DialogService, DatePipe],
})
export class DayOfferListComponent {
    display = false;
    selectedRole = '';
    selectedDate = '';
    searchText = '';
    ...
    loadBLogs(event: any) {
        ...
        this.dayOfferService.getAll(queryParams).subscribe((data: any) => {
    ...
    confirm2(event: Event, user) {
        this.confirmationService.confirm({
            ...
            accept: () => {
                this.dayOfferService.delete(user._id).subscribe((res) => {
                    this.messageService.add({
                        severity: 'success',
                        summary: 'Deleted',
                        detail: 'Day Offer Deleted Successfully',
                    });
    ...
    async updateStatus(id, status) {
        this.dayOfferService.update(id, { status }).subscribe((res) => {
            this.messageService.add({
                // key: 'tst',
                severity: 'success',
